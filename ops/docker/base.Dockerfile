...
COPY digest.py transit_discord.py github_discord.py watcher.py skills_discord.py ops_dashboard.py loop_dashboard.py embed_dashboard.py live_service.py /app/
